...
public abstract class AbstractHashCountWalk extends AbstractWalk {
    ...
    protected Path createPath(String fileOrDirName, BufferedWriter writer) throws WalkException {
        try {
            return Path.of(fileOrDirName);
        } catch (InvalidPathException e) {
            hashCounter.processFailedWriting(fileOrDirName, writer);
        }
